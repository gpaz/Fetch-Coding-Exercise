...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class KotlinxLibraryAccessors extends SubDependencyFactory {
        ...
        private final KotlinxLifecycleLibraryAccessors laccForKotlinxLifecycleLibraryAccessors = new KotlinxLifecycleLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>kotlinx.lifecycle</b>
         */
        public KotlinxLifecycleLibraryAccessors getLifecycle() {
            return laccForKotlinxLifecycleLibraryAccessors;
        }
    ...
    public static class KotlinxLifecycleLibraryAccessors extends SubDependencyFactory {
        private final KotlinxLifecycleLivedataLibraryAccessors laccForKotlinxLifecycleLivedataLibraryAccessors = new KotlinxLifecycleLivedataLibraryAccessors(owner);
        private final KotlinxLifecycleRuntimeLibraryAccessors laccForKotlinxLifecycleRuntimeLibraryAccessors = new KotlinxLifecycleRuntimeLibraryAccessors(owner);
        private final KotlinxLifecycleViewmodelLibraryAccessors laccForKotlinxLifecycleViewmodelLibraryAccessors = new KotlinxLifecycleViewmodelLibraryAccessors(owner);

        public KotlinxLifecycleLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>kotlinx.lifecycle.livedata</b>
         */
        public KotlinxLifecycleLivedataLibraryAccessors getLivedata() {
            return laccForKotlinxLifecycleLivedataLibraryAccessors;
        }

        /**
         * Group of libraries at <b>kotlinx.lifecycle.runtime</b>
         */
        public KotlinxLifecycleRuntimeLibraryAccessors getRuntime() {
            return laccForKotlinxLifecycleRuntimeLibraryAccessors;
        }

        /**
         * Group of libraries at <b>kotlinx.lifecycle.viewmodel</b>
         */
        public KotlinxLifecycleViewmodelLibraryAccessors getViewmodel() {
            return laccForKotlinxLifecycleViewmodelLibraryAccessors;
        }

    }

    public static class KotlinxLifecycleLivedataLibraryAccessors extends SubDependencyFactory {

        public KotlinxLifecycleLivedataLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>ktx</b> with <b>androidx.lifecycle:lifecycle-</b> coordinates and
         * with version reference <b>kotlinxLifecycleVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getKtx() {
            return create("kotlinx.lifecycle.livedata.ktx");
        }

    }

    public static class KotlinxLifecycleRuntimeLibraryAccessors extends SubDependencyFactory {

        public KotlinxLifecycleRuntimeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
         ...
         */
        public Provider<MinimalExternalModuleDependency> getKtx() {
            return create("kotlinx.lifecycle.runtime.ktx");
        }

    }

    public static class KotlinxLifecycleViewmodelLibraryAccessors extends SubDependencyFactory {

        public KotlinxLifecycleViewmodelLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
         ...
         */
        public Provider<MinimalExternalModuleDependency> getKtx() {
            return create("kotlinx.lifecycle.viewmodel.ktx");
        }
    ...
    public static class SquareupMoshiLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        private final SquareupMoshiKotlinLibraryAccessors laccForSquareupMoshiKotlinLibraryAccessors = new SquareupMoshiKotlinLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>squareup.moshi.kotlin</b>
         */
        public SquareupMoshiKotlinLibraryAccessors getKotlin() {
            return laccForSquareupMoshiKotlinLibraryAccessors;
        }

    }

    public static class SquareupMoshiKotlinLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public SquareupMoshiKotlinLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getCodegen() {
            return create("squareup.moshi.kotlin.codegen");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>kotlinxLifecycleVersion</b> with value <b>2.9.0-alpha07</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getKotlinxLifecycleVersion() { return getVersion("kotlinxLifecycleVersion"); }
        ...
        /**
         * Version alias <b>okhttpVersion</b> with value <b>5.0.0-alpha.14</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
